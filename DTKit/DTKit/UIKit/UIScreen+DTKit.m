...
#import "UIScreen+DTKit.h"
#import "DTKitMacro.h"
#import "UIDevice+DTKit.h"

SYNTH_DUMMY_CLASS(UIScreen_DTKit);


@implementation UIScreen (DTKit)

+ (CGFloat)dt_screenScale {
...
- (CGRect)dt_currentBounds {
    return [self dt_boundsForOrientation:[[UIApplication sharedApplication] statusBarOrientation]];
}

- (CGRect)dt_boundsForOrientation:(UIInterfaceOrientation)orientation {
...
- (CGSize)dt_sizeInPixel {
    CGSize size = CGSizeZero;
    
    if ([[UIScreen mainScreen] isEqual:self]) {
        NSString *model = [UIDevice currentDevice].dt_machineModel;
