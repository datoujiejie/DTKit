 ...
 */
- (CGRect)dt_currentBounds NS_EXTENSION_UNAVAILABLE_IOS("");
...
/**
 ...
 e.g. (768,1024)
 */
@property (nonatomic, readonly) CGSize dt_sizeInPixel;
...
/**
 ...
 Default value is 96.
 */
@property (nonatomic, readonly) CGFloat dt_pixelsPerInch;
