...
- (NSString *)dt_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
...
- (NSData *)dt_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)dt_hmacMD5StringWithKey:(NSString *)key {
    return [self dt_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)dt_hmacMD5DataWithKey:(NSData *)key {
    return [self dt_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)dt_hmacSHA1StringWithKey:(NSString *)key {
    return [self dt_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)dt_hmacSHA1DataWithKey:(NSData *)key {
    return [self dt_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)dt_hmacSHA224StringWithKey:(NSString *)key {
    return [self dt_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)dt_hmacSHA224DataWithKey:(NSData *)key {
    return [self dt_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSString *)dt_hmacSHA256StringWithKey:(NSString *)key {
    return [self dt_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)dt_hmacSHA256DataWithKey:(NSData *)key {
    return [self dt_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)dt_hmacSHA384StringWithKey:(NSString *)key {
    return [self dt_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)dt_hmacSHA384DataWithKey:(NSData *)key {
    return [self dt_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSString *)dt_hmacSHA512StringWithKey:(NSString *)key {
    return [self dt_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)dt_hmacSHA512DataWithKey:(NSData *)key {
    return [self dt_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
+ (NSData *)dt_dataWithHexString:(NSString *)hexStr {
