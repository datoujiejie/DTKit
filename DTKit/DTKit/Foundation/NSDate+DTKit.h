...
@property (nonatomic, readonly) NSInteger dt_year; ///< Year component
@property (nonatomic, readonly) NSInteger dt_month; ///< Month component (1~12)
@property (nonatomic, readonly) NSInteger dt_day; ///< Day component (1~31)
@property (nonatomic, readonly) NSInteger dt_hour; ///< Hour component (0~23)
@property (nonatomic, readonly) NSInteger dt_minute; ///< Minute component (0~59)
@property (nonatomic, readonly) NSInteger dt_second; ///< Second component (0~59)
@property (nonatomic, readonly) NSInteger dt_nanosecond; ///< Nanosecond component
@property (nonatomic, readonly) NSInteger dt_weekday; ///< Weekday component (1~7, first day is based on user setting)
@property (nonatomic, readonly) NSInteger dt_weekdayOrdinal; ///< WeekdayOrdinal component
@property (nonatomic, readonly) NSInteger dt_weekOfMonth; ///< WeekOfMonth component (1~5)
@property (nonatomic, readonly) NSInteger dt_weekOfYear; ///< WeekOfYear component (1~53)
@property (nonatomic, readonly) NSInteger dt_yearForWeekOfYear; ///< YearForWeekOfYear component
@property (nonatomic, readonly) NSInteger dt_quarter; ///< Quarter component
@property (nonatomic, readonly) BOOL dt_isLeapMonth; ///< whether the month is leap month
@property (nonatomic, readonly) BOOL dt_isLeapYear; ///< whether the year is leap year
@property (nonatomic, readonly) BOOL dt_isToday; ///< whether date is today (based on current locale)
@property (nonatomic, readonly) BOOL dt_isYesterday; ///< whether date is yesterday (based on current locale)
